      ...
      child: Scaffold(
        ...
        body: CustomScrollView(
          ...
          Text(widget.myReviewsModal.compoundName,
            ...
            SliverToBoxAdapter(child: SingleChildScrollView(child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Column(
                ...
                SizedBox(height: 10,),
                  ...
                  Text("Ratings",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,
                    fontSize: 16,
                    fontStyle:  FontStyle.normal,
                  ),),
                ...
                Padding(
                  ...
                  child: Text(widget.myReviewsModal.review,style:  TextStyle(
                      ...
                      fontStyle: FontStyle.normal,
                      fontSize: 14.0,wordSpacing: 2,letterSpacing: 0.3
                  ),
                      textAlign: TextAlign.left
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Text("Pros",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,
                        fontSize: 16,
                        fontStyle:  FontStyle.normal,
                      ),),
                        ...
                        itemBuilder: (context,index){
                          return Text("- "+widget.myReviewsModal.pros[index],
                            style:  TextStyle(
                                ...
                                fontWeight: FontWeight.w600,
                                fontStyle: FontStyle.normal,
                                fontSize: 13.0,wordSpacing: 2,letterSpacing: 0.3
                            ),);
                        },shrinkWrap: true,
